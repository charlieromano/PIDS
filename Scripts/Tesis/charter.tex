...
\titulo{PIDS: Sistema de información visual para pasajeros de Trenes Argentinos } 
...
\includepdf[pages={1},landscape]{Pics/output.driverLED.pdf}	
...
\includepdf[pages={1},landscape]{Pics/output.placaControl.pdf}	
