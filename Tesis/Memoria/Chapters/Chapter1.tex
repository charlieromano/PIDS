...
\begin{table}[H]
\caption[Caption for LOF]{Atributos y servicios asociados a sistemas PIDS.\protect\footnotemark}
...
\begin{table}[htbp]
\caption[Caption for LOF]{Características de displays para sistemas PIDS.}
...
\begin{table}[htbp]
\caption[Caption for LOF]{Características de controladores para sistemas PIDS.} \label{tab:tablaControladores}
\centering
...
\textbf{Conectividad}                                                       & \begin{tabular}[c]{@{}l@{}}UART (1-4)\\ USB (1-2)\\ RS485\\ GPIO (1-20)\\ Ethernet\end{tabular} & \begin{tabular}[c]{@{}l@{}}Pmod\\ I/O pins (20-800)\\ Ethernet\\ USB\end{tabular} & \begin{tabular}[c]{@{}l@{}}USB, Ethernet\\ VGA \\DVI, HDMI\\ PCI / PCI-E\end{tabular} \\ \hline
